        ...
        caseStudy: {
          ...
          sections: {
            ...
            logo: {
              ...
              description: "The NALES logo combines Bruno Ace SC for the lettermark and Salaryman for the wordmark. Bruno Ace SC is a techno geometric sans inspired by modern automotive logos with a wide stance and tall x·height, while Salaryman adds a complementary technical aesthetic.",
              anatomy: [
            ...
            typography: {
              ...
              description: "Two typefaces. One for authority, one for clarity. The hierarchy is strict, because clarity in a laboratory is non·negotiable. The NALES logo itself is a masterful blend of two complementary fonts: 'Bruno Ace SC' for the lettermark, a techno geometric sans inspired by modern automotive logos with a wide stance and tall x·height, paired with 'Salaryman' for the wordmark, adding a complementary technical aesthetic that reinforces the brand's scientific precision.",
              types: [
                { tag: "Display · H1", spec: "Bebas Neue · Bold<br>48–96px · Tracking −0.02em", sample: "NALES", sampleHighlight: "S", fontSize: "clamp(48px,7vw,80px)", fontFamily: "'Bebas Neue', sans-serif", letterSpacing: "0.02em", lineHeight: 0.95, color: "#F5F4F0" },
                { tag: "Heading · H2", spec: "Bebas Neue · Bold<br>28–40px · Tracking −0.01em", sample: "Precision in Every Detail", fontSize: "clamp(28px,4vw,42px)", fontFamily: "'Bebas Neue', sans-serif", letterSpacing: "0.02em", lineHeight: 0.95, color: "#F5F4F0" },
                { tag: "Subheading · H3", spec: "Instrument Sans · SemiBold<br>18–22px · Tracking 0", sample: "North American Laboratory Equipment Supplies & Services", fontSize: "20px", fontFamily: "Instrument Sans", fontWeight: 600, lineHeight: 1.6, color: "#F5F4F0" },
                { tag: "Body · P", spec: "DM Sans · Regular<br>14–16px · Line height 1.78", sample: "We supply precision laboratory equipment and professional services to research institutions, industrial facilities, and scientific organizations across North America. Every product is selected for accuracy, durability, and compliance.", fontSize: "15px", fontFamily: "'DM Sans', sans·serif", lineHeight: 1.78, color: "rgba(245,244,240,0.65)" },
                { tag: "Caption / Label", spec: "Syne · Regular<br>10–12px · Tracking 0.15em", sample: "Product Code · LAB·EQ·2024 · Certified ISO 9001", fontSize: "11px", fontFamily: "Syne, sans·serif", letterSpacing: "0.15em", textTransform: "uppercase", color: "#7AB928" }
              ]
            },
            applications: {
